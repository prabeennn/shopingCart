...
public class OrdersController {
	...
	public ModelAndView saveOrder(@ModelAttribute("ordersobj") Orders o, HttpSession session) {
		...
		mav.addObject("customerinfo", customer); // Add customerinfo attribute
		mav.addObject("itemslist", itemsList); // Add itemslist attribute
		mav.addObject("totalprice", totalpriceoforder);
